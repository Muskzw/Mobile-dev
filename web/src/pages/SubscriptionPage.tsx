            ...
            <div className="max-w-7xl mx-auto space-y-12 pb-20">
                <div className="text-center space-y-4">
                    ...
                    {user?.subscriptionStatus === 'trial' && (
                        <div className="inline-block bg-primary/10 text-primary px-4 py-1.5 rounded-full text-sm font-medium border border-primary/20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {plans.map((plan) => (
                        <div
                            key={plan.name}
                            className={`relative glass-card rounded-2xl border ${plan.popular ? 'border-primary shadow-lg scale-105 z-10' : 'border-border shadow-sm'
                                } p-8 flex flex-col transition-transform duration-300`}
                        >
                            {plan.popular && (
                                <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 bg-primary text-primary-foreground text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide shadow-lg">
                                    Most Popular
                                </div>
                            )}
